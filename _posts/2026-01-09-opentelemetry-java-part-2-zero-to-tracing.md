...
In [Part 1](/2026/01/08/opentelemetry-java-part-1-fundamentals/), we built the mental model for OpenTelemetry. Now it's time to get our hands dirty.
...
*Previous: [Part 1 - Understanding the Fundamentals](/2026/01/08/opentelemetry-java-part-1-fundamentals/)*

*Next: [Part 3 - Adding Custom Instrumentation](/2026/01/10/opentelemetry-java-part-3-custom-instrumentation/)*
