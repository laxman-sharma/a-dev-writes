...
In [Part 2]({{ site.url }}{{ site.baseurl }}/2026/01/09/opentelemetry-java-part-2-zero-to-tracing/), we got distributed tracing working with zero code changes. But the auto-generated spans are generic: `POST /orders`, `GET /inventory`. 
...
*Previous: [Part 2 - Zero to Tracing]({{ site.url }}{{ site.baseurl }}/2026/01/09/opentelemetry-java-part-2-zero-to-tracing/)*

*Next: [Part 4 - Metrics That Matter]({{ site.url }}{{ site.baseurl }}/2026/01/11/opentelemetry-java-part-4-metrics/)*
