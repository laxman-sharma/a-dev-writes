...
![OpenTelemetry Architecture - Java SDK to Collector to Backends]({{ site.url }}{{ site.baseurl }}/assets/images/otel-architecture.png)
...
*Next: [Part 2 - Zero to Tracing in 15 Minutes]({{ site.url }}{{ site.baseurl }}/2026/01/09/opentelemetry-java-part-2-zero-to-tracing/)*
