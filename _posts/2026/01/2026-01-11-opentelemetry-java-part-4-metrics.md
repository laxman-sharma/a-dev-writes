...
*Previous: [Part 3 - Custom Instrumentation]({{ site.url }}{{ site.baseurl }}/2026/01/10/opentelemetry-java-part-3-custom-instrumentation/)*

*Next: [Part 5 - Logs in Context]({{ site.url }}{{ site.baseurl }}/2026/01/12/opentelemetry-java-part-5-logs/)*
